	...
	: App(pWindow)
{
	...
	spEntity->SetShader(spEngine->CreateNewShaderFromFiles(std::filesystem::path(SHADERS_DIR)/"DemoContainerRGB.vert", "", std::filesystem::path(SHADERS_DIR)/"DemoContainerRGB.frag"));
