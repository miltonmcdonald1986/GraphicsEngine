...
namespace GraphicsEngine::GL
{
	...
	GRAPHICSENGINE_API auto VertexAttribFloatPointer(unsigned int index, int size, bool normalized, int stride, const void* pointer) -> void;
	...
	GRAPHICSENGINE_API auto DrawArraysAsTriangles(int first, int count) -> void;
	...
	GRAPHICSENGINE_API auto EnableVertexAttribArray(unsigned int index) -> void;

	GRAPHICSENGINE_API auto GenBuffers(int n, unsigned int* buffers) -> void;
