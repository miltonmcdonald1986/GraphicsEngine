...
Texture::Texture(std::string_view textureName,
  ...
  GL::TexImage2D(GL_TEXTURE_2D, 0, internalFormat, x, y, 0, format,
...
auto Texture::GetId() const -> GLuint { return m_Texture; }

auto Texture::GetName() const -> std::string_view { return m_Name; }
